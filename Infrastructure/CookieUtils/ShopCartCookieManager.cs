...
//Eshop.RazorPage.Infrastructure.CookieUtils;
namespace AppRazorPage.Infrastructure.CookieUtils;
...
public class ShopCartCookieManager
{
   ...
   // private readonly ISellerService _sellerService; ISellerService sellerService,
    private readonly IProductService _productService;
    public ShopCartCookieManager(CookieManager.ICookieManager cookieManager, IProductService productService)
    {
